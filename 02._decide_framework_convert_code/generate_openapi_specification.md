...
You have been provided with the following OpenAPI Specification file [`api-schema.yaml`](api-schema.yaml). You downloaded it in the last lecture 
and it is in the repository on [github](https://github.com/cookbookio/awsome_recipe_cookbook). 
