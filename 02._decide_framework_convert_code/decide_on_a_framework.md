...
**Deadline**: Immediately after lecture 2 so that you can coordinate and create a battle plan with your group. 
...
You are not allowed to use `Flask` or any `Kotlin` based frameworks.


## Choose a micro-web-framework

Advice: Do not choose full-webframeworks like Django, Blazor, Spring MVC, Ruby on Rails, C#.Net. 
...
| [Javascript](https://nodejs.org/)            | [Node.js](https://nodejs.org/)                          |
| [Javascript](https://nodejs.org/)            | [Vue.js](https://vuejs.org/)                          |
| [Javascript](https://nodejs.org/)            | [svelte](https://svelte.dev/)                          |
...
### Client-side rendering: The client is stand-alone and fetches data from the server. The server only sends data (through an api). 
...
You don't have to decide on a database yet. Keep using the SQLite database until we cover the topic of databases.  
...
This will be usefull and expected at you exam.
